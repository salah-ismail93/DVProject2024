<template>
    ...
    <div class="bg-white px-6 lg:px-8 py-22 main">
      <div class="mx-auto max-w-5xl text-center">
        <h2 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-4xl">Europe Climate Action Initiatives</h2>
      </div>
        ...
        <div class="bg-white px-6 lg:px-8 text-center">
          <div class="mx-auto max-w-5xl">
            <p class="mx-auto mt-6 max-w-2xl text-base leading-8 text-gray-600 text-center">
              In this section we will discuss the world contribution as climate action initiatives against global warming and raising the 
              awareness of SDGs
            </p>
            <p class="mt-4 text-base leading-7 text-indigo-600 sm:text-2xl">1990-2021</p>
          </div>
        </div>
      </div>
    </div>
