<template>
  <div class="mx-auto">
    <h3 class="text-2xl font-bold tracking-tight text-gray-900 sm:text-2xl">
      The Conference of the Parties (COP)    </h3>
      
    <div>The Conference of the Parties (COP) is the main decision-making body of the United Nations Framework Convention on Climate Change (UNFCCC). It brings together the 198 Parties –197 nations plus the European Union – that have signed on to the Framework Convention.
